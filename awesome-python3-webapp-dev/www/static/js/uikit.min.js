...
!function (a) {
        ...
        remainIdle: !1, show: function () {
            ...
            if (this.dropdown.length) {
                var b = this.dropdown.css("margin-" + a.UIkit.langdirection, "").css("min-width", ""),
                    c = b.show().offset(), d = b.outerWidth(), e = this.boundary.width(),
    ...
    a.extend(g.prototype, {
        scrollable: !1, transition: !1, toggle: function () {
            ...
            if (this.scrollbarwidth = window.innerWidth - f.width(), f.css(a, this.scrollbarwidth), this.element.css(a, ""), this.dialog.offset().left > this.scrollbarwidth && this.element.css(a, this.scrollbarwidth - (this.element[0].scrollHeight == window.innerHeight ? 0 : this.scrollbarwidth)), this.scrollable) {
                ...
                var c = Math.abs(parseInt(this.dialog.css("margin-top"), 10)), d = this.dialog.outerHeight(),
                    e = window.innerHeight, g = e - 2 * (20 > c ? 20 : c) - d;
    ...
    }), g.dialog = {tpl: '<div class="uk-modal"><div class="uk-modal-dialog"></div></div>'}, g.defaults = {
        keyboard: !0,
        show: !1,
        bgclose: !0,
        minScrollHeight: 150
    ...
    var c, d = a(window), e = a(document), f = {
        show: function (b) {
            if (b = a(b), b.length) {
                var g = a("html"), h = b.find(".uk-offcanvas-bar:first"), i = "right" == a.UIkit.langdirection,
                    j = (h.hasClass("uk-offcanvas-bar-flip") ? -1 : 1) * (i ? -1 : 1),
                    k = -1 == j && d.width() < window.innerWidth ? window.innerWidth - d.width() : 0;
                c = {x: window.scrollX, y: window.scrollY}, b.addClass("uk-active"), g.css({
            ...
            var d = a("html"), f = a(".uk-offcanvas.uk-active"), g = "right" == a.UIkit.langdirection,
        ...
        tip: "", show: function () {
            if (e && clearTimeout(e), this.tip.length) {
                ...
                var b = this, c = a.extend({}, this.element.offset(), {
                    ...
                    j = {display: "none", visibility: "visible", top: c.top + c.height + g, left: c.left},
                    k = i.split("-");
                "left" != k[0] && "right" != k[0] || "right" != a.UIkit.langdirection || (k[0] = "left" == k[0] ? "right" : "left");
                var l = {
                    bottom: {top: c.top + c.height + h, left: c.left + c.width / 2 - f / 2},
                    top: {top: c.top - g - h, left: c.left + c.width / 2 - f / 2},
                    left: {top: c.top + c.height / 2 - g / 2, left: c.left - f - h},
                    right: {top: c.top + c.height / 2 - g / 2, left: c.left + c.width + h}
                };
                ...
                j.left -= a("body").position().left, e = setTimeout(function () {
                    d.css(j).attr("class", "uk-tooltip uk-tooltip-" + i), b.options.animation ? d.css({
                        opacity: 0,
                        display: "block"
                    }).animate({opacity: 1}, parseInt(b.options.animation, 10) || 400) : d.show(), e = !1
    ...
    var c = function (b, d) {
        ...
        if (!f.data("tab")) {
            ...
            }), h.append(j).uk("dropdown", {mode: "click"}), this.element.append(h).data({
    ...
    var c = function (b, d) {
        ...
        f.data("smoothScroll") || (this.options = a.extend({}, c.defaults, d), this.element = f.on("click", function () {
            {
                var b = a(a(this.hash).length ? this.hash : "body"), c = b.offset().top - e.options.offset,
                    d = a(document).height(), f = a(window).height();
                b.outerHeight()
            }
